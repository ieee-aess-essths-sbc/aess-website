...
export default function Header() {
  ...
  return (
      ...
      <div className="background">
        <Navigation />
        <header className="p-8 flex flex-row max-lg:flex-wrap-reverse max-md:flex-wrap-reverse max-sm:flex-wrap sm:flex-wrap-reverse md:justify-center lg:flex-nowrap lg:justify-center lg:px-16">
          <div className=" lg:w-[50%] flex flex-1 max-md:flex-row sm:flex-row sm:justify-start sm:p-2 md:justify-start md:p-14 lg:flex-col lg:justify-between ">
            <div className="flex flex-1 flex-col sm:justify-center lg:w-[50%] lg:justify-between gap-2">
              <div className="flex gap-5 sm:item-center  max-sm:flex-row md:flex-1 md:flex-col lg:flex-1 lg:flex-col lg:justify-center">
                ...
                <div className="sm:item-center flex flex-col max-sm:items-center max-sm:justify-end md:justify-center lg:flex-1 lg:justify-center">
                  <span className="fontheader animated-title z-5 text-7xl leading-20 max-md:text-center max-sm:mb-4 max-sm:w-full max-sm:text-4xl md:mb-4 md:text-center lg:text-left lg:mb-8 lg:text-8xl">
                 ...
                 {/* Solang +join us */}
                  <div className="flex max-sm:flex-col-reverse max-sm:items-center max-sm:justify-center sm:flex-col-reverse lg:justify-between">
                    ...
                    <div className=" font-light max-sm:w-80 max-sm:text-center max-sm:text-sm sm:text-center sm:text-sm sm:leading-none lg:mb-5 lg:text-left lg:text-2xl lg:leading-10 lg:w-150">
                      “Innovating Aerospace and Electronic Systems, Shaping the Future.”
                    </div>
                  </div>
                </div>
                 {/* media icons */}
                <div className="flex gap-2  lg:flex-row lg:justify-start lg:items-start md:flex-row md:justify-center  max-md:flex-col 
